...
import classes from './gel_card.module.css';
import {Grid} from "@material-ui/core";
import Paper from "@material-ui/core/Paper";
import {useHistory} from "react-router";


function GelCard(props){
            ...
            <Paper elevation={6}>
                <div className={classes.card}>
                    ...
                    <div className={classes.bg_white}>
                        ...
                        <span className={classes.v}>Обьём: {props.v}L</span>
                        {props.discountPrice
                            ?
                    ...
                    <button className={classes.buy}
                            onClick={() => history.push(`/gel/${props.name.toLowerCase()}/${props.id}`)}>Подробнее
                    </button>
                </div>
            </Paper>
        </Grid>
